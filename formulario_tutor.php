...
<body>
  ...
  <script>
    function eliminar() {
      var respuesta = confirm("¿Desea elimnar este tutor?");
      return respuesta
    }
  </script>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link " href="formulario_tutor.php">
          <i class="bi bi-person"></i>
  ...
  <main id="main" class="main">
    ...
    ?>
    <h1 class="text-center p-3">Registre un nuevo tutor</h1>
    <?php

    include "controlador/registro_tutor.php";
    ?>
          ...
          <tbody>
            ...
            while ($datos = $sql->fetch_object()) { ?>
              <tr>
                ...
                <td>
                  <a href="modificar_tutor.php?id=<?= $datos->idTutor ?>" class="btn btn-small btn-warning"><i
                      class="fa-solid fa-pen-to-square"></i></a>
                  <a onclick="return eliminar()" href="formulario_tutor.php?id=<?= $datos->idTutor ?>"
